...
def main():
    ...
    parser.add_argument("-r", "--reverse", action="store_true", help="reverse input order")
    parser.add_argument("-n", "--number", type=int, default=0, help="Number argument that becomes app exit code")
    parser.add_argument("-p","--positive_words", type=int, default=1, help="Positive words argument")
    parser.add_argument("-ne","--negative_words", type=int, default=1, help="Negative words argument")
    ...
    # Check if inputs are between 0 and 10
        ...
        log.print_and_log(f"{args.positive_words} positive words and {args.negative_words} negative words printed to file")
