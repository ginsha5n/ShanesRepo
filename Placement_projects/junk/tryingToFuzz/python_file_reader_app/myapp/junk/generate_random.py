"""
A group of functions that can create files with 'x' lines and 'y' words on each line
either random characters or random words taken from another file.
"""
import random
import string
...
def write_random_sentences(new_file, num_sentences, words_per_sentence):
    """
    Creates a new file with lines and words on each lines
    """
